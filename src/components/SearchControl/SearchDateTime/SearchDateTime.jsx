...
class SearchDateTime extends Component {
  ...
  constructor(props, context) {
    ...
    if (searchQueryAnd[column]) {
      ...
      this.state = Object.assign({}, initState, {
        currentTimezone: this.props.displayTimeZone,
      });
    }
  }
  ...
  componentDidUpdate() {
    ...
    if (displayTimeZone !== currentTimezone) {
      let newFrom = isEmpty(from)
        ? ""
        : DateTime.fromFormat(from, "yyyy-MM-dd HH:mm:ss", {
            zone: currentTimezone,
          })
            .setZone(displayTimeZone)
            .toFormat("yyyy-MM-dd HH:mm:ss");
      let newTo = isEmpty(to)
        ? ""
        : DateTime.fromFormat(to, "yyyy-MM-dd HH:mm:ss", {
            zone: currentTimezone,
          })
            .setZone(displayTimeZone)
            .toFormat("yyyy-MM-dd HH:mm:ss");
        ...
        <div className="attribute-filter">
          <Flatpickr
            ...
            options={{
              ...
              enableSeconds: true,
              altInput: true,
              altFormat: this.datePickerFormat(),
            }}
            name="from"
            placeholder="from"
          />
